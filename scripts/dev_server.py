...
def _build_home_data(portal_group: int, role: str, subscription: str) -> dict:
    ...
    if portal_group == 1:
        data["kpis"] = [
            {"label": "Active Institutions", "value": "12,483", "trend": "+24 this week"},
        ...
        data["recent_insts"] = [
            {"name": "Delhi Public School — Rohini", "type": "school",    "registered_at": "2 hrs ago"},
            {"name": "Sunrise B.Ed College",          "type": "college",   "registered_at": "5 hrs ago"},
            {"name": "Victory IAS Academy",           "type": "coaching",  "registered_at": "Yesterday"},
        ]
        data["alerts"] = [
    ...
    # ── Group 2: Chain Admin ──────────────────────────────────────────────────
        ...
        data["kpis"] = [
            ...
            {"label": "Avg Attendance", "value": "91.4%", "trend": "↑ 1.2% vs last week"},
        ]
        data["branches"] = [
            {"id": 1, "name": "EduForge — Connaught Place", "student_count": 2340, "staff_count": 84, "attendance_pct": "93%", "status": "active"},
            {"id": 2, "name": "EduForge — Dwarka",          "student_count": 1980, "staff_count": 71, "attendance_pct": "89%", "status": "active"},
            {"id": 3, "name": "EduForge — Noida Sector 62", "student_count": 1560, "staff_count": 58, "attendance_pct": "94%", "status": "active"},
            {"id": 4, "name": "EduForge — Gurugram DLF",    "student_count": 2100, "staff_count": 76, "attendance_pct": "88%", "status": "review"},
        ]
        data["alerts"] = [
    ...
    # ── Group 3: School ───────────────────────────────────────────────────────
        ...
        data["kpis"] = [
            {"label": "Today's Attendance", "value": "94%",     "trend": "892 / 948 students"},
        ...
        data["alerts"] = [
            ...
            {"message": "Annual Day registrations close in 2 days",
             "action_label": "Manage", "action_url": "#"},
            {"message": "2 staff leave requests pending approval",
             "action_label": "Review", "action_url": "#"},
        ]
        if role == "teacher":
            data["today_schedule"] = [
                {"time": "08:30", "class": "Grade 10A", "subject": "Mathematics", "room": "Room 12"},
                {"time": "10:00", "class": "Grade 11B", "subject": "Physics",     "room": "Lab 2"},
                {"time": "11:30", "class": "Grade 9C",  "subject": "Mathematics", "room": "Room 7"},
                {"time": "14:00", "class": "Grade 12A", "subject": "Calculus",    "room": "Room 15"},
            ]
        elif role == "parent":
            data["ward"] = {
                "name": "Aryan Verma", "class": "Grade 10A",
                "attendance_today": "Present", "recent_marks": "85/100 (Maths)",
    ...
    # ── Group 4: College ──────────────────────────────────────────────────────
        ...
        data["kpis"] = [
            {"label": "Today's Attendance", "value": "87%",  "trend": "1,240 / 1,424 students"},
        ...
        data["dept_stats"] = {"attendance_today": "87%", "student_count": 1424, "faculty_count": 66}
        data["classes"] = [
            {"id": 1, "time": "09:00", "subject": "Data Structures",     "class_name": "CS-3A", "room": "LH-4",  "faculty": "Dr. Mehta"},
            {"id": 2, "time": "10:30", "subject": "Digital Electronics", "class_name": "EC-2B", "room": "LH-7",  "faculty": "Prof. Iyer"},
            {"id": 3, "time": "12:00", "subject": "Thermodynamics",      "class_name": "ME-4A", "room": "LH-2",  "faculty": "Dr. Sharma"},
            {"id": 4, "time": "14:00", "subject": "Fluid Mechanics",     "class_name": "CE-3A", "room": "LH-10", "faculty": "Dr. Kulkarni"},
        ]
        data["items"] = [
        ...
        data["alerts"] = [
            {"message": "Internal marks upload due by Apr 8",
             "action_label": "Upload Now", "action_url": "#"},
        ]

    # ── Group 5: Coaching ─────────────────────────────────────────────────────
    elif portal_group == 5:
        data["kpis"] = [
            {"label": "Active Batches",    "value": "12",    "trend": "3 batches starting next week"},
            {"label": "Students Enrolled", "value": "1,840", "trend": "+60 this month"},
            {"label": "Avg Test Score",    "value": "68.4%", "trend": "↑ 3.2% vs last month"},
        ]
        data["batches"] = [
        ...
        data["classes"] = [
            {"id": 1, "time": "07:00", "subject": "Quantitative Aptitude", "batch": "SSC CGL Morning",  "room": "Hall A", "faculty": "Rajesh Sir"},
            {"id": 2, "time": "09:30", "subject": "English Grammar",       "batch": "SSC CHSL Evening", "room": "Hall B", "faculty": "Priya Ma'am"},
            {"id": 3, "time": "11:00", "subject": "General Awareness",     "batch": "RRB NTPC Weekend", "room": "Hall C", "faculty": "Anand Sir"},
            {"id": 4, "time": "14:00", "subject": "Reasoning",             "batch": "Banking Morning",  "room": "Hall A", "faculty": "Meena Ma'am"},
        ]
        data["tests"] = [
            {"name": "SSC CGL Full Mock #12", "date": "Mar 15", "score": "142/200", "rank": "8 / 240"},
            {"name": "Reasoning Sprint #6",   "date": "Mar 12", "score": "48/60",   "rank": "12 / 240"},
            {"name": "GK Weekly #9",          "date": "Mar 10", "score": "35/50",   "rank": "5 / 320"},
        ]
        data["alerts"] = [
    ...
    # ── Group 6: Exam Domain ──────────────────────────────────────────────────
        ...
        data["kpis"] = [
            {"label": "Sessions This Month", "value": "12", "sub": "/30 limit" if subscription == "free" else "Unlimited", "icon": "📚", "trend": ""},
            {"label": "Best AIR",            "value": "3,421", "sub": "Top 5% nationally", "icon": "🏆", "trend": ""},
            {"label": "Study Streak",        "value": "7 days", "sub": "Strong — keep going!", "icon": "🔥", "trend": ""},
        ]
        data["best_air"] = "3,421"
        data["last_month_tests"] = 18
        data["live_tests"] = [
            {"name": "SSC CGL Tier-I Full Mock #24", "url": "#", "remaining": "1h 20m", "attempts": 2840},
            {"name": "RRB NTPC CBT-1 Sprint #8",     "url": "#", "remaining": "45m",    "attempts": 1240},
        ]
        data["results"] = [
            {"test_name": "SSC CGL Mock #23", "score": "142/200", "score_label": "71%",
             "air": 3421, "date": "Mar 18", "analysis_url": "#"},
            {"test_name": "Quant Sprint #11", "score": "48/60", "score_label": "80%",
             "air": 890, "date": "Mar 16", "analysis_url": "#"},
            {"test_name": "GK Weekly #14",    "score": "35/50", "score_label": "70%",
             "air": 2100, "date": "Mar 14", "analysis_url": "#"},
        ]
    ...
    # ── Group 7: TSP (Tech Service Provider) ─────────────────────────────────
        ...
        data["kpis"] = [
            ...
            {"label": "API Calls (Today)",   "value": "2.4M",  "trend": "Peak 14:00–16:00"},
            {"label": "Avg API Latency",     "value": "42ms",  "trend": "SLA: < 200ms ✓"},
        ]
        data["clients"] = [
            {"id": 1, "name": "Sunrise Degree College",   "type": "college",  "student_count": 1424, "status": "active"},
            {"id": 2, "name": "Toppers Coaching Centre",  "type": "coaching", "student_count": 1840, "status": "active"},
            {"id": 3, "name": "Greenwood High School",    "type": "school",   "student_count": 948,  "status": "active"},
            {"id": 4, "name": "Victory IAS Academy",      "type": "coaching", "student_count": 620,  "status": "onboarding"},
        ]
        data["api_health"] = [
    ...
    # ── Group 9: B2B Partner ──────────────────────────────────────────────────
        ...
        data["content_items"] = [
            {"title": "SSC CGL Quant Masterclass",      "type": "Video",    "views": 24800, "revenue": "₹12,400"},
            {"title": "Banking Awareness Notes 2024",   "type": "PDF",      "views": 18600, "revenue": "₹9,300"},
            {"title": "RRB NTPC Previous Papers Pack",  "type": "Test Set", "views": 15200, "revenue": "₹7,600"},
            {"title": "English Grammar for SSC — Vol 2","type": "eBook",    "views": 9400,  "revenue": "₹4,700"},
        ]
        data["revenue"] = {
            "this_month":     "₹48,200",
            "last_month":     "₹40,800",
    ...
    # ── Group 10: Student Unified ─────────────────────────────────────────────
        ...
        data["institutions"] = [
            {"name": "Greenwood High School",  "type": "School",  "role": "Student",
             "portal_url": "http://localhost:8000", "primary_color": "#1B5E20"},
            {"name": "Toppers Coaching Centre","type": "Coaching","role": "Student",
             "portal_url": "http://localhost:8000", "primary_color": "#4A148C"},
            {"name": "EduForge SSC",           "type": "Exam",    "role": "Aspirant",
             "portal_url": "http://localhost:8000", "primary_color": "#1565C0"},
        ]
        data["today_schedule"] = [
            {"title": "Mathematics Class",         "time": "09:00", "type": "class",  "institution": "Greenwood High School"},
            {"title": "SSC CGL Mock Test #24",     "time": "11:00", "type": "exam",   "institution": "EduForge SSC"},
            {"title": "Quantitative Aptitude",     "time": "16:00", "type": "class",  "institution": "Toppers Coaching Centre"},
        ]
        data["deadlines"] = [
            {"title": "Annual Exam Registration",  "institution": "Greenwood High",   "days_left": 2},
            {"title": "Fee Payment — Semester 2",  "institution": "Greenwood High",   "days_left": 5},
            {"title": "RRB NTPC Application",      "institution": "EduForge SSC",     "days_left": 12},
        ]
        data["alerts"] = [
