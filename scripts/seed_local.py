...
def seed_tenants(conn: sqlite3.Connection):
    tenants = [
        ...
        ("greenwood-school","Greenwood High School",   3, "greenwood.school.com","#1B5E20"),
        ("sunrise-college", "Sunrise Degree College",  4, "sunrise.college.com", "#E65100"),
        ("toppers-coaching","Toppers Coaching Centre",  5, "toppers.coaching.com","#4A148C"),
...
def seed_users(conn: sqlite3.Connection):
    ...
    users = [
        ...
        # Platform Admin
        ("+910000000001","platform@eduforge.in","platform_admin", pwd,"Arjun Mehta",    "platform_admin","platform-admin","free"),
        # Chain Admin
        ("+910000000002","chain@eduforge.in",   "chain_admin",    pwd,"Priya Sharma",   "chain_admin",   "chain-admin",  "free"),
        # School — Principal
        ("+910000000003","principal@greenwood.com","principal",   pwd,"Dr. Rajan Nair", "principal",     "greenwood-school","free"),
        # School — Teacher
        ("+910000000004","teacher@greenwood.com","teacher",       pwd,"Sujata Rao",     "teacher",       "greenwood-school","free"),
        # School — Student
        ("+910000000005","student@greenwood.com","student1",      pwd,"Rahul Verma",    "student",       "greenwood-school","free"),
        # School — Parent
        ("+910000000006","parent@greenwood.com","parent1",        pwd,"Meera Verma",    "parent",        "greenwood-school","free"),
        # College — Principal
        ("+910000000007","hod@sunrise.com",     "college_principal",pwd,"Prof. Anil Kumar","principal", "sunrise-college","free"),
        # College — Faculty
        ("+910000000008","faculty@sunrise.com", "faculty1",      pwd,"Dr. Kavitha S",  "faculty",       "sunrise-college","free"),
        # College — Student
        ("+910000000009","coll_std@sunrise.com","coll_student",  pwd,"Ananya Pillai",  "student",       "sunrise-college","free"),
        # Coaching — Director
        ("+910000000010","director@toppers.com","director",      pwd,"Naresh Gupta",   "director",      "toppers-coaching","free"),
        # Coaching — Student
        ("+910000000011","coach_std@toppers.com","coach_student",pwd,"Vikram Singh",   "student",       "toppers-coaching","free"),
        # Exam Domain — Free Student
        ("+919876543210","aspirant@ssc.com",    "aspirant1",     pwd,"Deepak Yadav",   "student",       "ssc-domain","free"),
        # Exam Domain — Premium Student
        ("+919876543211","premium@ssc.com",     "premium1",      pwd,"Pooja Mishra",   "student",       "ssc-domain","premium"),
        # TSP Admin
        ("+910000000014","admin@techedu.in",    "tsp_admin",     pwd,"Kiran Reddy",    "tsp_admin",     "tsp-demo","free"),
        # B2B Partner
        ("+910000000015","partner@contentpro.in","b2b_partner",  pwd,"Suresh Joshi",   "partner",       "b2b-partner","free"),
        # Student Unified
        ("+910000000016","unified@student.in",  "unified_student",pwd,"Arun Krishnan", "student",       "student-unified","free"),
    ]
...
def print_summary(conn: sqlite3.Connection):
    ...
    print("\nTenants:")
    for row in conn.execute("SELECT slug, name, portal_group, domain FROM tenants ORDER BY portal_group"):
